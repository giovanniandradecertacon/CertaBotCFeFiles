package br.com.certacon.certabotcfefiles.dto;
...
public class ProcessFileDto {
    ...
    public ProcessFileModel toModel() {
        List<CFeFileModel> listaDeArquivos = new ArrayList<>();
        listaDeArquivos.add(CFeFileModel.builder()
                .id(arquivoId)
                .build());
        return ProcessFileModel.builder()
                ...
                .username(username)
                .filePath(filePath)
                .arquivosCFeModel(listaDeArquivos)
                .build();
    }
}
