        ...
        if (modelOptional.isPresent()) {
            ...
            if (inputSearchTabElement.isPresent()) {
                ...
                if (clickSearchElement.isPresent()) {
                    Optional<WebElement> cnpjForCFeElement = helper.findElementByXpathAndDoubleClick(1000L, 30L, "/html/body/div[6]/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/div/div[3]/div[2]/div/div/div/div/div[1]/div/div[2]/div/div[2]/div[1]/div/div[3]/div[2]/div/table/tbody/tr[1]", remoteWebDriver);

                    if (cnpjForCFeElement.isPresent()) {
                        Optional<WebElement> cfeElement = helper.findElementByXpathAndDoubleClick(1000L, 30L, "/html/body/div[6]/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/div/div[3]/div[2]/div/div/div/div/div[1]/div/div[2]/div/div[2]/div[1]/div/div[3]/div[2]/div/table/tbody/tr[8]", remoteWebDriver);

                        if (cfeElement.isPresent()) {
                                            ...
                                            if (cnpjClickEspecificElement.isPresent()) {
                                                ...
                                                if (confirmButtonElement.isPresent()) {
                                                    ...
                                                    if (inputFilePathElement.isPresent()) {
                                                        ...
                                                        Thread.sleep(25000);
                                                        do {
                                                            Optional<WebElement> time = helper.findElementByXpathAnGetText(1000L, 20L, "/html/body/div[32]/div[1]/div/div/div/div/div/div/div[1]/div[2]", remoteWebDriver);
                                                            Optional<WebElement> dataForTableElement = helper.findElementByXpathAnGetText(1000L, 20L, "/html/body/div[32]/div[1]/div/div/div/div/div/div/div[3]/div/div[3]/div/div[1]/div", remoteWebDriver);
                                                            if (dataForTableElement.isPresent() && time.isPresent()) {
                                                                String[] timeSplitted = time.get().getText().split("\n");
                                                                String[] dataTable = dataForTableElement.get().getText().split(":");
                                                                if (timeSplitted.length == 3) {
                                                            ...
                                                            modal = helper.findElementIsPresent(1000L, 5L, "/html/body/div[32]/div[1]", remoteWebDriver);
                                                        } while (modal.isPresent());
                                                        Optional<WebElement> errorProxy = helper.findElementIsPresent(1000L, 5L, "/html/body/div[33]", remoteWebDriver);
                                                        if (errorProxy.isPresent()) {
                                                            modelOptional.get().setStatus(ProcessStatus.PROXY_ERROR);
                                                        }
                                                        Optional<WebElement> validAndInvalidFiles = helper.findElementByXpathAnGetText(3000L, 200L, "/html/body/div[6]/div[2]/div/div/div/div/div/div[2]/div/div/div/div[1]/div/div[3]/div[2]/div/div/div/div/div[1]/div/div[2]/div/div[1]/div/div/div/div[2]/div[2]/div/table/tbody/tr/td[2]/div", remoteWebDriver);
